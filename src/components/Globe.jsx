...
export function Globe() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-white w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4 pb-6">
        <motion.div 
          initial={{
            opacity: 0,
            y: 20,
          ...
          className="div"
        >
          <h2 className="text-center text-xl md:text-4xl font-bold text-black dark:text-slate-300">
            Welcome to JSON Schema Playground
          </h2>
